...
print("Num GPUs Available: ", len(tf.config.experimental.list_physical_devices('GPU'))) # HERE
...
def main():
    ...
    if imagenet_indexes is None:
      print("ERROR: The class label you gave does not exist")
      exit()
    ...
    print("ACTIVE MODELS: " + str(active_models))
